...
function milieux_rss_dashboard_widget() {
	...
	if ($limit == 0) echo '<div>' . __( 'The RSS Feed is either empty or unavailable.', 'milieux' ) . '</div>';   // fallback message
	else foreach ($items as $item) { ?>

	<h4 style="margin-bottom: 0;">
		<a href="<?php echo $item->get_permalink(); ?>" title="<?php echo mysql2date(__('j F Y @ g:i a', 'milieux'), $item->get_date('Y-m-d H:i:s')); ?>" target="_blank">
